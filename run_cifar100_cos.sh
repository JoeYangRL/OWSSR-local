...
## CIFAR100 B0-5 steps
# task 1
python3 main2.py --steps 5 --world_size 2 --num_workers 1 --port 29554 --output_path ./output/cifar100_b0-5steps-cos --now_step 1 --lr 0.06 --eval_step 128 --epoch 512 --warmup_epoch 0 --lambda_oem 0.1 --lambda_socr 1.0 --threshold 0.5 --batch_size 64 --start_fix 40 --timestamp 20211124104446 --use-ema
# step 2
#python3 main.py --steps 5 --world_size 2 --num_workers 1 --port 29555 --output_path ./output/cifar100_b0-5steps --now_step 2 --lr 0.06 --eval_step 128 --epoch 512 --warmup_epoch 0 --lambda_oem 0.05 --lambda_socr 1.0 --lambda_dist 1.0 --threshold 0.5 --batch_size 64 --start_fix 40 --timestamp 20211124104446 --use-ema --online_distill 0 --mu_m 1
## CIFAR100 B80-1 steps
# task 1
#python3 main.py --base_task_cls 80 --steps 1 --world_size 2 --num_workers 1 --port 29554 --output_path ./output/cifar100_20_syncbn --now_step 1 --lr 0.06 --eval_step 512 --epoch 128 --warmup_epoch 0 --lambda_oem 0.1 --lambda_socr 1.0 --threshold 0.0 --batch_size 64 --start_fix 10 --timestamp 20211203154700 --use-ema